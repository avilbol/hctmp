...
import static com.hallocasa.systemproperties.SystemConstants.MAIL_CHIMP_API_KEY;
import static com.hallocasa.systemproperties.SystemConstants.MAIL_CHIMP_TEST1_LIST_ID;
...
public class MailChimpClient implements Closeable {
	...
	/**
	 * Constructs a {@code MailChimpClient} object accessing MailChimp API
	 * service point through the default connection manager (currently
	 * {@link HttpClientConnectionManager}).
	 */
	...
	/**
	 * Constructs a {@code MailChimpClient} object accessing MailChimp API
	 * service point through the specified connection manager.
	 * <p>
	 * Use this constructor if the default connection manager (currently
	 * {@link HttpClientConnectionManager}) is not suitable. For instance, in
	 * GAE environment you should use {@link JavaNetURLConnectionManager}
	 * instead.
	 * 
	 * @param connection
	 *            connection manager to be used to access the service point
	 */
	 ...
	 * 
	 * @param method
	 *            MailChimp API method to be executed
	...
	public static void main(String[] args) {
		...
		subscribeMethod.merge_vars = null;
