 ...
 */
@Stateless
public class WcmPersistenceServicesImpl implements WcmPersistenceServices {

    @PersistenceContext(unitName = "RealStateDatabasePU")
    private EntityManager em;
    @SuppressWarnings("unused")
    private static final Logger LOG = Logger.getLogger(WcmPersistenceServicesImpl.class.getName());
     ...
     * @param em
     */
    protected WcmPersistenceServicesImpl(EntityManager em) {
        this.em = em;
        initialize();
    }
     ...
     * Default Constructor
     */
    public WcmPersistenceServicesImpl() {
    }
