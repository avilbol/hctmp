...
public class CountryVOParser extends HallocasaVOParser<Country, CountryVO> {
	...
	/* Methods */
	@Override
	protected void copyEntityPropertyToValueObjectProperty(CountryVO vo, Country entity, String propertyName,
	...
	@Override
	protected void copyVOPropertyToEntityProperty(CountryVO vo, Country entity, String propertyName,
			Object propertyValue, Object[] options) throws IllegalAccessException, InvocationTargetException {
	 ...
	 */
	public void copyVOToEntity(CountryVO vo, Country entity, boolean excludeIpList)
