 ...
 * @since 1.7
 */
public class CurrencyVOParser extends HallocasaVOParser<Currency, CurrencyVO> {

	
	/**
     * Constructor
     */
    public CurrencyVOParser() {
        super();
    }
    ...
    /* Methods */
    @Override
    protected void copyEntityPropertyToValueObjectProperty(CurrencyVO vo,
            Currency entity, String propertyName, Object propertyValue,
    ...
    @Override
    protected void copyVOPropertyToEntityProperty(CurrencyVO vo, Currency entity,
     ...
     */
    public void copyVOToEntity(CurrencyVO vo, Currency entity,
