...
mvn -f %hc_home%/hallocasamig/pom.xml clean install -Dwar.output.location=%war_location% -Dglassfish.base=%glassfish_base% -Dglassfish.domain=%glassfish_domain% -Dglassfish.admin.port=%glassfish_admin_port% -Dlogsdir=%logs_dir%
