...
/**
 * Value Object that represents a Property Field
 * @author Alexander Villamil
 */
public class PropertyFieldVO implements Serializable, ValueObject {
    ...
    public boolean equals(Object obj) {
        ...
        PropertyFieldVO other = (PropertyFieldVO) obj;
        if (id == null) {
            if (other.id != null) {
                return false;
            }
