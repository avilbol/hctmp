package com.mobiera.hallocasa.commons.i18n;
...
public class ValidationMessages {
	...
	public static final String EMAIL_PATTERN = "com.mobiera.social.validator.constrains.EmailPattern.message";
	public static final String NOT_EMPTY = "com.mobiera.social.validator.constrains.NotEmpty.message";
	public static final String IP = "com.mobiera.social.validator.constrains.Ip.message";
	public static final String URL_PATTERN = "com.mobiera.social.validator.constrains.UrlPattern.message";
	public static final String PHONE_PATTERN = "com.mobiera.social.validator.constrains.PhonePattern.message";
	public static final String PASSWORD_PATTERN = "com.mobiera.social.validator.constrains.PasswordPattern.message";
	public static final String GENERAL_NAME_PATTERN = "com.mobiera.social.validator.constrains.GeneralNamePattern.message";
	public static final String ADDRESS_PATTERN = "com.mobiera.social.validator.constrains.AddressPattern.message";
	public static final String USE_CASE_NAME_PATTERN = "com.mobiera.social.validator.constrains.UseCasePattern.message";
